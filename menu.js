...
const Menu = ({ visible, onClose, onNavigate }) => {
  ...
  const MenuItem = ({ icon, text, onPress, isLast = false }) => (
    <TouchableOpacity style={styles.menuItem} onPress={onPress} activeOpacity={0.7}>
      ...
      {!isLast && <View style={styles.menuItemBorder} />}
    </TouchableOpacity>
  );
          ...
          <View style={styles.menuContent}>
            ...
            <View style={styles.menuItems}>
              <MenuItem 
                ...
                onPress={() => handlePress('Cursos Técnicos', 'cursos')} 
              />
              <MenuItem 
                icon="📝" 
                text="Blog" 
                onPress={() => handlePress('Blog', 'blog')} 
              />
              <MenuItem 
                icon="⚙️" 
                text="Administração" 
                onPress={() => handlePress('Administração', 'administracao')} 
                isLast={true}
              />
            </View>
            
            <View style={styles.buttonsSection}>
              <TouchableOpacity style={styles.contatosButton} onPress={() => handlePress('Contatos', 'contatos')} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  // Botão de Contatos (transparente com borda)
  contatosButton: { 
