...
export default function App() {
  ...
  const [currentScreen, setCurrentScreen] = useState('home'); // 'home' ou 'cursos'

  // Callbacks memoizados para evitar recriação desnecessária
  ...
  const handleFooterLink = useCallback((linkText) => {
    if (linkText === 'Cursos') {
      setCurrentScreen('cursos');
    } else {
      console.log(`${linkText} pressionado`);
    }
  }, []);
  ...
  const FixedHeader = useMemo(() => (
    <View style={styles.fixedHeaderContainer}>
      ...
      <AnimatedMenuButton onPress={handleMenuPress}>
        {MenuIcon}
      </AnimatedMenuButton>
    </View>
  ), [handleMenuPress, MenuIcon]);

  // Renderiza a tela de cursos
  ...
  // Renderiza a tela principal (home)
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <ImageBackground
          source={require('./img/Rectangle 41.png')}
        ...
        <View style={styles.contentSections}>
          ...
          <View style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>What is lorem ?</Text>
          ...
          <View style={styles.sectionContainer}>
            ...
            <Text style={styles.readMore}>
              McClintock.Contrary to popular belief, Lorem Ipsum is not simply 
          ...
          <View style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>What is lorem ipsum?</Text>
            <Text style={styles.sectionText}>
              McClintock.Contrary to popular belief, Lorem Ipsum is not simply 
              random text. It has roots in a piece of classical Latin literature 
              from 45 BC, making it over 2000 years old.
          ...
          <View style={styles.quickLinksSection}>
            ...
            {FOOTER_LINKS.map((link) => (
              <TouchableOpacity 
                ...
                onPress={() => handleFooterLink(link.text)}
              >
